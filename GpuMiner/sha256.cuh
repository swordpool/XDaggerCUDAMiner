...
__device__ void sha256_init(SHA256_CTX_X *ctx);
__device__ void sha256_update(SHA256_CTX_X *ctx, const BYTE data[], size_t len);
__device__ void sha256_final(SHA256_CTX_X *ctx, BYTE hash[]);
...
__device__ void sha256_transform(SHA256_CTX_X *ctx, const BYTE data[])
{
